...
var defaultParametrs = {
  name: {
    "M": ["Мурзик", "Барсик", "Жорик", "Макс"],
    "F": ["Мурка", "Ася", "Кэтти", "Василиса"]
  },
  age: [3, 5, 7, 10, 12],
  gender: ["M", "F"],
...
function catFactory() {
  var defaults = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : defaultParametrs;
  var gender = pick(defaults.gender == undefined ? defaultParametrs.gender : defaults.gender);
  var cat = {
